...
wire [1:0] chunk_insts_3_k_a;

assign chunk_insts_3_k_a[1] = chunk_insts_4_button_o;
assign chunk_insts_3_k_a[0] = chunk_insts_3_button_o;
...
always @(posedge clk_i) begin: CLASSIC_FSM_LOC_INSTS_CHUNK_INSTS_4_LOC_INSTS_CHUNK_INSTS_0
    if ((inputs_i[1] == chunk_insts_4_prev_button)) begin
...
assign dbnc_inputs = chunk_insts_3_k_a;
